...
class simBTF():
	...
	def __init__(self, outdir=[]):
		...
		self.dispersionFlag = 1 # if 1 will correct for dispersion in recorded twiss parameters
	...
	def run(self,**kwargs):
		...
		if self.bunch_in.getSize() > 1:
			self.tracker = bunchUtil.bunchTrack(dispersionFlag=self.dispersionFlag,emitnormFlag=self.emitnormFlag)
	...
	def initLattice(self,beamline=["MEBT1","MEBT2","MEBT3"],xml=None,mstatename=None,mdict=None,units='Amps',ds=0.012,coeffilename=''):
		"""
