...
class bunchCalculation():
    ...
    def Twiss(self,plane='x',dispersion_flag=0, emit_norm_flag = 0):
        """
        plane = 'x' (or 'y' or 'z')
        ...
        if dispersion_flag: # correct for dispersion in twiss calculation (for x and y)
    ...
    def NormCoord(self,plane='x',plotflag=0):
        ...
        ###############################################################################
        twiss = self.Twiss(plane=plane,emit_norm_flag=1)
...
class bunchTrack():
    ...
    def action_entrance(self,paramsDict):
        ...
        twissx = bunchCalc.Twiss(plane='x',dispersion_flag=self.dispersion_flag,emit_norm_flag=self.emit_norm_flag)
        ...
        twissy = bunchCalc.Twiss(plane='y',dispersion_flag=self.dispersion_flag,emit_norm_flag=self.emit_norm_flag)
        (alphaY,betaY,emittY) = (twissy['alpha']['value'], twissy['beta']['value'],twissy['emit']['value'])
        twissz = bunchCalc.Twiss(plane='z',dispersion_flag=self.dispersion_flag,emit_norm_flag=self.emit_norm_flag)
        ...
        order = 2; 
        self.twiss_analysis.computeBunchMoments(bunch,order,self.dispersion_flag,self.emit_norm_flag)
